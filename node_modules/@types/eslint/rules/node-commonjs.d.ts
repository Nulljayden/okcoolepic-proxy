import { RuleEntry, RuleRecord } from "../index";

export interface NodeJSAndCommonJS extends RuleRecord {
  /**
   ...
   */
  "callback-return": RuleEntry<[string[]]>;
   ...
   */
  "handle-callback-err": RuleEntry<[string]>;
   ...
   */
  "no-buffer-constructor": RuleEntry<[]>;
   ...
   */
  "no-restricted-modules": RuleEntry<
    [
      ...Array<
        | string
        | {
